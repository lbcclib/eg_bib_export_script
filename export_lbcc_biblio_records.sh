...
cat /home/opensrf/records.txt | ./marc_export --store -i -c /openils/conf/opensrf_core.xml -x /openils/conf/fm_IDL.xml -f USMARC --timeout 5 > $starting_dir/exported_files.xml
